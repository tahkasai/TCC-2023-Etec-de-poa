...
<div class="navigattion">
    ...
    <div class="content-edit">
        <div class="edit-user">
            <a href="adm_agenda.php" class="voltar"><i class="fa-solid fa-arrow-left"></i> Voltar</a>
            <h2>Palestra dia: <?php echo $agenda['dataselecionada']; ?> </h2>
            <p> Veja os principais detalhes da sua palestra</p>

            <div class="justify-content">
                <div class="form-edit">
                    <div class="edit-top">
                        <h3>Dados da palestra</h3>
                    </div><br>
                    <form action="php/finalizar.php" method="post" class="form-edit-perfil">
                        ...
                        <button class="button-edit" name="finalizar" id="finalizar">Finalizar Palestra</button>
                    </form>
                </div>
                <div>
